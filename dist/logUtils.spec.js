...
describe('logUtils', function () {
    ...
    it('ignoreRouteLogging', function (done) {
        (0, _chai.expect)((0, _logUtils.ignoreRouteLogging)(container)({ path: '/health' }, null)).to.be.true;
        (0, _chai.expect)((0, _logUtils.ignoreRouteLogging)(container)({ path: '/currencies/USD' }, null)).to.be.true;
        (0, _chai.expect)((0, _logUtils.ignoreRouteLogging)(container)({ path: '/currencies/USA_DOLLAR' }, null)).to.be.false;
        done();
    });
